Shader "Custom/Wireframe"
{
    ...
    SubShader
    {
        Tags {"Queue" = "Transparent" "RenderType" = "Quaque" "RenderPipeline" = "UniversalPipeline" "IgnoreProjector"="True" }
        LOD 100
...
#pragma multi_compile _ BLEND_ON
			//enable alpha premultiply
#pragma multi_compile _ ALPHAPREMULTIPLY_ON
