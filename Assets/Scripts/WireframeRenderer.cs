...
public class WireframeRenderer : MonoBehaviour
{
    ...
    void Validate()
    {
        if (wireframeRenderer == null || wireframeRenderer.sharedMaterial == null)
        {
    ...
    void CreateWireframeRenderer()
    {
        ...
        wireframeGO.tag = "Wireframe renderer";
        wireframeGO.transform.SetParent(originalRenderer.transform);
        wireframeGO.transform.SetLocalPositionAndRotation(Vector3.zero, Quaternion.identity);
        ...
        else
        {
            ...
            wireframeSkinnedMeshRenderer.rootBone = originalSkinnedMeshRenderer.rootBone;
